% The function to calculate the Inverse Discrete Fourier Transform of an image
function [idft] = idft2D(img)
    ...
    weight_col = (1/M) * exp(weight_col);

    % Taking M-point DFT of the previous N-point DFT
    idft = weight_row * (img * weight_col);
